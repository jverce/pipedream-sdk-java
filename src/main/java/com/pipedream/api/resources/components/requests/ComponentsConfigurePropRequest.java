...
@JsonDeserialize(builder = ComponentsConfigurePropRequest.Builder.class)
public final class ComponentsConfigurePropRequest {
    ...
    private ComponentsConfigurePropRequest(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ComponentsConfigurePropRequest && equalTo((ComponentsConfigurePropRequest) other);
    }
    ...
    private boolean equalTo(ComponentsConfigurePropRequest other) {
    ...
    public interface BodyStage {
        ...
        Builder from(ComponentsConfigurePropRequest other);
    }

    public interface _FinalStage {
        ComponentsConfigurePropRequest build();
    ...
    public static final class Builder implements BodyStage, _FinalStage {
        ...
        @java.lang.Override
        public Builder from(ComponentsConfigurePropRequest other) {
        ...
        @java.lang.Override
        public ComponentsConfigurePropRequest build() {
            return new ComponentsConfigurePropRequest(asyncHandle, body, additionalProperties);
        }
    }
}
